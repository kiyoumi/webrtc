...
Erizo.VideoPlayer = function (spec) {
    ...
    L.Logger.debug('Creating URL from stream ' + spec.stream,spec.stream.stream);
    ...
    that.loader.setAttribute('src', that.url + './erizoClient/assets/loader.gif');
